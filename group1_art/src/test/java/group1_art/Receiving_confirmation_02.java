...
public class Receiving_confirmation_02 {
  ...
  public void login(String email, String password) {
		...
		ExtentSparkReporter reporter = new ExtentSparkReporter("./TestReport11.html");
		
		ExtentReports extent = new ExtentReports();
		
		extent.attachReporter(reporter);
		ExtentTest test = extent.createTest("TC02-Verification to the registered email id");
